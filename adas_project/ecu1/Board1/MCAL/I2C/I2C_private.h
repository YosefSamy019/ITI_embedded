...
#define DATA_READ_AND_ACK_HAS_BEEN_TRANSMITTED        (0x50)
#define DATA_READ_AND_NACK_HAS_BEEN_TRANSMITTED       (0x58)
#define SLAVE_ADDRESS_HAS_BEEN_RESEVED                (0x60)
#define DATA_AND_ACK_HAS_BEEN_RESEVED                 (0x80)
#define SLAVE_ADDRESS_AND_READ_HAS_BEEN_TRANSMITTED   (0x40)
