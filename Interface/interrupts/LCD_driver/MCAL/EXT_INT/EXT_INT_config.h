...
#define EXT_INT_CONFIG_H_
 ...
 #define MEXT_INT_0_INPUT_DIRECTION			MEXT_INT_PIN_INPUT
 #define MEXT_INT_1_INPUT_DIRECTION			MEXT_INT_PIN_INPUT
 #define MEXT_INT_2_INPUT_DIRECTION			MEXT_INT_PIN_INPUT
