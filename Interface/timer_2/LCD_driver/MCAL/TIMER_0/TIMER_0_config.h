...
#define MTIMER0_PRELOAD_VAL 192		//NORMAL OR CTC
#define MTIMER0_MAX_COUNT 3907		//NORMAL OR CTC
...
#define MTIMERO_MODE_SELECT MTIMER0_MODE_PHASE_CORRECT
...
#define MTIMER0_OC0_SELECT MTIMER0_OC0_MODE_2
